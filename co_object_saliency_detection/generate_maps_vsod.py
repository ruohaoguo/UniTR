...
if __name__ == '__main__':
    ...
    parser.add_argument('--datasets', default=['DAVIS', 'FBMS', 'SegV2', 'ViSal'])
    parser.add_argument('--output_dir', default='./predictions/', help='directory for result')
    ...
    for dataset in args.datasets:
        ...
        save_root_path = [args.output_dir + 'vsod/' + dataset]
