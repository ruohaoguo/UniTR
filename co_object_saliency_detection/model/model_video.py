...
class Model(nn.Module):
    def __init__(self, incr_channel, incr_channel2, concat_r, concat_1):
        ...
        self.mm_transformer = CoFormer(dim=512, depth=4, heads=4, mlp_dim=782, group=10)
    ...
    def forward(self, x):
        ...
        cls, mmf = self.mm_transformer(p3_hf)

        cls = self.cls_1(cls)
        cls_pred = self.cls_2(cls)
        ...
        mask_pred = self.sigm(pred_mask_logits)
