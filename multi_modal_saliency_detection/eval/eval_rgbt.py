...
from utils.metric_data_rgbt import test_dataset
from utils.saliency_metric import cal_mae,cal_fm,cal_sm,cal_em,cal_wfm


gt_path = '../datasets/rgbt/test/'
prediction_path = '../predictions/unitr_rgbt_swin/'
# prediction_path = '../predictions/unitr_rgbt_vgg/'
