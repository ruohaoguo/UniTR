...
from .res_backbone import resnet101
from .zoomformer_256 import ZoomFormer
...
def incr_channel():
    ...
    layers += [nn.Conv2d(2048, 512, 3, 1, 1)]
    return layers
...
class Model(nn.Module):
    def __init__(self, incr_channel, incr_channel2, concat_r, concat_1, demo_mode=False):
