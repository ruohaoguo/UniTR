...
class Model(nn.Module):
    def __init__(self, base, incr_channel, incr_channel2, concat_r, concat_1, demo_mode=False):
...
def build_model():
    return Model(vgg(base['vgg']), incr_channel(), incr_channel2(), concat_r(), concat_1())
