...
# from models.unitr_vgg import build_model
from data.data import test_dataset

parser = argparse.ArgumentParser()
parser.add_argument('--image_size', type=int, default=224, help='testing size')
# parser.add_argument('--test_path',type=str,default='../datasets/rgbt/test/')
parser.add_argument('--model_path',type=str,default='../save_models/unitr_rgbt_swin.pth')
parser.add_argument('--model_path',type=str,default='../save_models/unitr_rgbt_vgg.pth')
...
for dataset in test_datasets:
    print(dataset)
    save_path = '../predictions/unitr_rgbt_swin/' + dataset + '/'
    # save_path = '../predictions/unitr_rgbt_vgg/' + dataset + '/'
